        ...
        <div class="m-2 p-2 bg-slate-100 rounded">
            ...
            <form method="POST" action="{{route('admin.menus.store')}}"  enctype="multipart/form-data">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    <input type="number" min='0.00' max='100000.0' step='1' name="price" id="price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('price') border-red-400 @enderror" placeholder=" " required />
                ...
                @enderror
                  <div class="relative z-0 w-full mb-6 group">
                    ...
                    <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 @error('image') border-red-400 @enderror" aria-describedby="user_avatar_help" id="image" type="file" name='image' >
                ...
                <div class="relative z-0 w-full mb-6 group">    
                    ...
                    <select  id='categories' name='categories[]' class='form-multiselect w-full mt-1 @error('categories[]') border-red-400 @enderror' multiple required>
