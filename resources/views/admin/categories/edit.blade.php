    ...
    <div class="py-12">
        ...
        <div class="m-2 p-2 bg-slate-100 rounded">
            ...
            <form method="POST" action='{{route('admin.categories.update', $category->id)}}' enctype="multipart/form-data">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <div class="">
                    <input type="text" value='{{$category->description}}' name="description" id="description" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('description') border-red-400 @enderror" placeholder=" "  />
